...
const { pixels, w, h, bpp } = getPixels('public/hero_girl_phone.png');

console.log("Analyzing bottom rows of hero_girl_phone.png (y = 410, 420, 429):");
const ys = [410, 420, 429];
const xs = [0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1023];
